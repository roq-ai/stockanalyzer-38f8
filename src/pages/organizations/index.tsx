...
function OrganizationListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<OrganizationInterface[]>(
    ...
    () =>
      getOrganizations({
        relations: ['user', 'analysis.count', 'criteria.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('criteria', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>criteria</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
