...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'financial-analyst', 'stock-trader'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Analysis', path: '/analyses', entity: 'analysis', service: AccessServiceEnum.PROJECT, icon: FiBarChart2 },
    {
      name: 'Criteria',
      path: '/criteria',
      entity: 'criteria',
